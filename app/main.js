...
export default function Main({tasks, deleteTask, fetchData, editTask}){
  ...
  return (
    <div className="flex flex-col justify-center h-screen items-center">
      ...
      <div className="fixed flex flex-col bg-gray-200 justify-center items-center task-list-div overflow-y-auto w-full h-[calc(100vh-50px)] top-20">
        {/* tasklist div */}
          <Tasklist deleteTask = {deleteTask} fetchData = {fetchData} tasks={tasks} editTask={editTask}/>
      </div>
