        ...
        <div className={backgroundColour}>
                    ...
                    {taskData ? (
                        <>
                            ...
                            <div className="relative row flex-row mt-7 m-3"> 
                                <button className="text-slate-400 text-l mr-5 hover:text-slate-500" onClick={startTimer}>
                                    Start Timer
                                </button>
                                <button className="text-slate-400 text-l hover:text-slate-500" onClick={stopTimer}>
                                    Stop Timer
                                </button>
                            </div> 
                            <div className="relative m-2"> 
                                <Link className="text-slate-300 text hover:text-slate-500" onClick={updateTask} href="/">
                                    Go Back
                                </Link>
                            </div>
                        </>
            ...
            {taskCompleted && (
                <>
                    ...
                    <Link className="text-slate-300" onClick={deleteTask} href="/">
                        Finish task
                    </Link>          
                </>
            )}
